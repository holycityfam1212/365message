                ...
                <div className="relative w-[320px] flex flex-col items-center flex-shrink-0 mt-4 mb-28">
                    ...
                    {capsuleDropped && (
                        ...
                        >
                            ...
                            {/* Text positioned relative to viewport center */}
                            <div className="fixed bottom-[10%] left-1/2 -translate-x-1/2 px-4 py-2 bg-gradient-to-r from-purple-300 to-pink-300 text-white rounded-full text-xs font-semibold whitespace-nowrap animate-bounce shadow-md z-50">
                                클릭해서 열어보세요 ✨
                            </div>
                        </div>
                    )}
